...
Title: Agent2
Version: Python 2.7
This Algorithm is our second optimal agent where the main idea is the agent stands still unless some enemy comes in its
point of action.
"""
import argparse
...
class Agent(object):
    ...
    def follow_row(self, myrow, mycol, r, c, wall, mypos):
        """
           This method follows all the rows and checks all the conditions preventing suicide according to the rows
           :param myrow: Current agent row
           :param mycol: Current agent column
           :param r: r is the row location of exit pass
           :param c: c is the column location of exit pass
    ...
    def follow_coll(self, myrow, mycol, r, c, wall, mypos):
        ...
        """
               This method follows all the columns and checks all the conditions preventing suicide according to the columns
               :param myrow: Current agent row
               :param mycol: Current agent column
               :param r: r is the row location of exit pass
               :param c: c is the column location of exit pass
